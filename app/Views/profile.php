...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Hi, <?= esc($darren->username) ?>!</h2>
                ...
                <div class="col-12 col-md-12 col-lg-5">
                    <div class="card profile-widget">
                        <div class="profile-widget-header text-center">
                            <!-- Profile Image -->
                            <?php
                                $foto_profil = ($darren->foto) ? base_url('img/avatar/' . $darren->foto) : base_url('img/avatar/user.png');
                            ?>
                        ...
                        <div class="profile-widget-description">
                            <div class="profile-widget-name">
                                ...
                                <div class="text-muted d-inline font-weight-normal">
                                    <div class="slash"></div><?= esc($darren->nis) ?>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">                               
                                    <div class="form-group col-md-6 col-12">
                                        <label>Nis</label>
                                        <input type="text" class="form-control" value="<?= esc($darren->nis) ?>" readonly="">
                                ...
                                <div class="row">                               
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="username" value="<?= esc($darren->username) ?>" required="">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        <label>Email</label>
                                        <input type="email" class="form-control" name="email" value="<?= esc($darren->email) ?>" required="">
                                        <div class="invalid-feedback">
    ...
    <script>
        ...
        var timeoutDuration = 300 * 1000; // 5 minutes in milliseconds
        setTimeout(function() {
