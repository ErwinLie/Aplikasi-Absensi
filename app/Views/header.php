...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url('modules/weather-icon/css/weather-icons.min.css')?>">
  <link rel="stylesheet" href="<?= base_url('modules/weather-icon/css/weather-icons-wind.min.css')?>">
